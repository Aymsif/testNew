...
public class DB_helper extends SQLiteOpenHelper {
    public final static String DB_NAME = "dalili_3.db";
    ...
    public void close() {
     ...
     ArrayList<DataModel> get_universities_data(int type,String lang) {
        ...
        switch (lang)
        {
            ...
            case "en":
            {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    String name = cursor.getString(cursor.getColumnIndex("uinever_name_en"));
                    String icon = cursor.getString(cursor.getColumnIndex("univer_icon"));
                    dataModel.setName(name);
                    dataModel.setIcon(icon);
                    dataModel.setId(id);
    ...
    public ArrayList<DataModel> get_universities_info(int id,String lang) {
        ...
        switch (lang)
        {
            ...
            case "en":
            {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    String name = cursor.getString(cursor.getColumnIndex("uinever_name_en"));
                    String info = cursor.getString(cursor.getColumnIndex("univer_info_en"));
                    String image = cursor.getString(cursor.getColumnIndex("univer_image"));
                    dataModel.setName(name);
                    dataModel.setImage(image);
                    dataModel.setInfo(info);
    ...
    public ArrayList<DataModel> get_faculties_data(int type,String lang) {
        ...
        switch (lang)
        {
            ...
            case "en":
            {
                ...
                Cursor cursor = sqLiteDatabase.rawQuery("Select universities.univer_id,universities.univer_image,universities.uinever_name_en,faculties.* From faculties Left join universities on (faculties.univer_id = universities.univer_id) where faculties.univer_id = " + type, null);
                cursor.moveToFirst();
                while (!cursor.isAfterLast()) {
                    DataModel dataModel = new DataModel();
                    int id = cursor.getInt(cursor.getColumnIndex("facu_id"));
                    String name = cursor.getString(cursor.getColumnIndex("facu_name_en"));
                    String image = cursor.getString(cursor.getColumnIndex("univer_image"));
                    String title = cursor.getString(cursor.getColumnIndex("uinever_name_en"));
                    dataModel.setName(name);
                    dataModel.setImage(image);
                    dataModel.setId(id);
                    dataModel.setTitle(title);
    ...
    public String get_dept_info(int id,String lang) {
        ...
        switch (lang)
        {
            ...
            case "en":
            {
                ...
                while (!cursor.isAfterLast()) {
                    ...
                    cont++;
                    int department_id = cursor.getInt(cursor.getColumnIndex("dept_id"));
                    name += cont + " - " + cursor.getString(cursor.getColumnIndex("dept_name_en")) + "\n";
                    ...
                    if (department_id != 0) {
                        ...
                        cursor2.moveToFirst();
                        while (!cursor2.isAfterLast()) {
                            String sub_name = cursor2.getString(cursor2.getColumnIndex("sub_name_en"));
                            name += "\t\t\t\t\t - " + sub_name + "\n";
                            cursor2.moveToNext();
                        }
